...
def slice(v1,v2):
     v1,v2=[pair for pair in v1 if 900 <= pair[0] <= 1000],[pair for pair in v2 if 900 <= pair[0] <= 1000]
     return v1,v2
...
def mesclar(v, v2):
    ...
    while True:
        ...
        if (v[0][0] >= 900 and v[0][0] <= 1000) and v2[0][0] > v[0][0]:  # and(v[0][0]<(v[0][0]+1))
            # ZONA DE CONFLITO
            aux.append(v[0][0])
